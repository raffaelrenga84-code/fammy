 ...
 */
export default function BirthdayReminder({ members, session }) {
  ...
  const openGiftChat = async (member) => {
    // Questo potrebbe aprire una conversazione dedicata al regalo
    // Per ora, mostra un alert
    alert(`💝 Organizzazione regalo per ${member.name}!\n\nPossibilità futura: conversazione dedicata al regalo`);
  };
